...
das Experiment ist nun zu Ende und ich möchte mich ganz herzlich bei allen Teilnehmern bedanken, da sie die Grundlage für einen wichtigen Bestandteil meiner Masterarbeit geschaffen haben, also vielen, vielen, vielen Dank.

Die Voting-Stimmen sind nun ausgewertet und der Gewinner steht fest. Falls Sie ihre Punktzahl erfahren möchten, können Sie diese auf http://master.yanenko.de mit den gewohnten Zugangsdaten einsehen.

Ich werde in den nächsten Tagen die wichtigsten Ergebnisse des Experiments in einem Dokument zusammenfassen und allen Interessierten zusenden.
...
Olga Yanenko';
		...
		if (mail($email, "Das Experiment ist zu Ende", $mailtext, $headers)) {
